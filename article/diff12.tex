...
%DIF DEL msculled_revised_1.tex   Tue Jul  3 17:48:36 2018
%DIF ADD msculled_revised_2.tex   Mon Jul  9 18:19:45 2018
%
...
%DIFDELCMD < \multicolumn{5}{c}{J075043.12+204658.0} %%%
\DIFdelendFL \DIFaddbeginFL \begin{tabular}{lccccc}
\multicolumn{6}{c}{J075043.12+204658.0} \DIFaddendFL \\
\hline
Species & $N$ & $\log_\epsilon(\textrm{X})$ & [X/\DIFaddbeginFL \DIFaddFL{H}] & [\DIFaddFL{X/}\DIFaddendFL Fe] & $\sigma/\sqrt{N}$ \\
\hline
\DIFaddbeginFL \ion{Fe}{I} & \DIFaddFL{82 }& \DIFaddFL{6.95 }& \DIFaddFL{$-$0.55 }&    \DIFaddFL{0.00 }& \DIFaddFL{0.02 }\\
\DIFaddendFL \ion{Mg}{I} & 3  & 7.39 & \DIFaddbeginFL \DIFaddFL{$-$0.21 }& \DIFaddendFL $+$0.34 & 0.13 \\
\ion{K}{I}  & 2  & 5.33 & $+$\DIFaddbeginFL \DIFaddFL{0.30 }& \DIFaddFL{$+$}\DIFaddendFL 0.85 & 0.07 \\
\hline
\\
\DIFdelbeginFL %DIFDELCMD < \multicolumn{5}{c}{J091825.48+172114.5} %%%
\DIFdelendFL \DIFaddbeginFL \multicolumn{6}{c}{J091825.48+172114.5} \DIFaddendFL \\
\hline
Species & $N$ & $\log_\epsilon(\textrm{X})$ & [X/\DIFaddbeginFL \DIFaddFL{H}] & [\DIFaddFL{X/}\DIFaddendFL Fe] & $\sigma/\sqrt{N}$ \\
\hline
\DIFaddbeginFL \ion{Fe}{I} & \DIFaddFL{43 }& \DIFaddFL{6.51 }& \DIFaddFL{$-$0.99 }&    \DIFaddFL{0.00 }& \DIFaddFL{0.03 }\\
\DIFaddendFL \ion{Mg}{I} & 5  & 6.56 & $-$\DIFaddbeginFL \DIFaddFL{1.04 }& \DIFaddFL{$-$}\DIFaddendFL 0.05 & 0.08 \\
\ion{K}{I}  & 2  & 5.32 & $+$\DIFaddbeginFL \DIFaddFL{0.29 }& \DIFaddFL{$+$}\DIFaddendFL 1.28 & 0.31 \\
\hline
\\
\DIFdelbeginFL %DIFDELCMD < \multicolumn{5}{c}{J120032.60+024438.2} %%%
\DIFdelendFL \DIFaddbeginFL \multicolumn{6}{c}{J120032.60+024438.2} \DIFaddendFL \\
\hline
Species & $N$ & $\log_\epsilon(\textrm{X})$ & [X/\DIFaddbeginFL \DIFaddFL{H}] & [\DIFaddFL{X/}\DIFaddendFL Fe] & $\sigma/\sqrt{N}$ \\
\hline
\DIFaddbeginFL \ion{Fe}{I} & \DIFaddFL{77 }& \DIFaddFL{6.56 }& \DIFaddFL{$-$0.14 }& \DIFaddFL{0.00 }& \DIFaddFL{0.03 }\\
\DIFaddendFL \ion{Mg}{I} & 4  & 6.96 & $+$\DIFaddbeginFL \DIFaddFL{0.16 }& \DIFaddFL{$+$}\DIFaddendFL 0.30 & 0.09 \\
\ion{K}{I}  & 2  & 4.96 & $+$\DIFaddbeginFL \DIFaddFL{0.72 }& \DIFaddFL{$+$}\DIFaddendFL 0.86 & 0.11 \\
\hline
\end{tabular}
\end{table}
...
\begin{figure}
    ...
    \caption{[K/Fe] vs [$\alpha$/Fe] for the candidate stars, overlaid with [K/Fe] vs [Mg/Fe] abundances for NGC 2419 and NGC 2808 \citep{cohenkirby2012, mucciarelli2012, mucciarelli2015} \DIFaddbeginFL \DIFaddFL{as well as the three candidates observed using Magellan/MIKE (red diamonds)}\DIFaddendFL . \DIFaddbeginFL \DIFaddFL{These three stars' abundances as per the \lamost\ spectra are indicated in the figure (red circles). }\DIFaddendFL Note that in principle, [$\alpha$/Fe] acts only as an upper limit for [Mg/Fe] \DIFdelbeginFL \DIFdelFL{, }\DIFdelendFL and is used as such for our sample in this figure due to difficulties in calculating reliable [Mg/Fe] from \lamost\DIFaddbeginFL \DIFaddFL{\ }\DIFaddendFL data.}
    \label{KvsMg}
\end{figure}
...
J000908.89+124821.9 & \DIFdelbeginFL \DIFdelFL{2.29 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{2.2871 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{12.81 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{12.8061 }\DIFaddendFL & 10 & -78.55 & 4892 & 2.82 & -0.12 & 0.33 & 0.19 & 1.08 & 0.26 & 0.86 & 0.23 \\
J002619.36+565612.1 & \DIFdelbeginFL \DIFdelFL{6.58 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{6.5807 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{56.94 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{56.9367 }\DIFaddendFL & 31 & -39.57 & 4205 & 1.49 & 0.22 & 0.06 & 0.76 & 0.62 & 0.22 & 0.39 & 0.22 \\
J002907.61+354701.0 & \DIFdelbeginFL \DIFdelFL{7.28 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{7.2817 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{35.78 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{35.7836 }\DIFaddendFL & 15 & -82.74 & 5116 & 3.56 & 0.24 & 0.17 & 0.18 & 1.01 & 0.21 & -0.20 & 0.20 \\
J003451.10+424543.0 & \DIFdelbeginFL \DIFdelFL{8.71 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{8.7130 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{42.76 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{42.7620 }\DIFaddendFL & 15 & -79.15 & 4460 & 2.10 & -0.56 & 0.24 & 0.31 & 0.96 & 0.33 & -0.16 & 0.20 \\
J005649.98+391722.9 & \DIFdelbeginFL \DIFdelFL{14.21 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{14.2083 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{39.29 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{39.2897 }\DIFaddendFL & 41 & -46.77 & 4578 & 2.67 & 0.31 & 0.1 & 0.44 & 0.76 & 0.23 & -0.02 & 0.20 \\
J010305.95+043445.9 & \DIFdelbeginFL \DIFdelFL{15.77 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{15.7748 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{4.58 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{4.5794 }\DIFaddendFL & 90 & 20.69 & 4646 & 2.72 & 0.1 & 0.05 & 1.17 & 0.95 & 0.21 & -0.07 & 0.20 \\
J011949.36+063411.4 & \DIFdelbeginFL \DIFdelFL{19.96 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{19.9557 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{6.57 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{6.5699 }\DIFaddendFL & 479 & -28.18 & 4820 & 2.61 & -0.29 & 0.09 & 2.38 & 1.03 & 0.20 & -0.04 & 0.20 \\
J013039.08+404843.8 & \DIFdelbeginFL \DIFdelFL{22.66 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{22.6628 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{40.81 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{40.8122 }\DIFaddendFL & 71 & -80.34 & 4355 & 2.01 & -0.09 & 0.14 & 0.93 & 0.92 & 0.21 & 0.46 & 0.21 \\
J030101.42+560042.3 & \DIFdelbeginFL \DIFdelFL{45.26 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{45.2560 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{56.01 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{56.0118 }\DIFaddendFL & 88 & -39.27 & 4878 & 2.53 & -0.32 & 0.09 & 0.67 & 1 & 8.70 & -0.02 & 0.20 \\
J032423.46+425429.6 & \DIFdelbeginFL \DIFdelFL{51.1 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{51.0978 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{42.91 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{42.9082 }\DIFaddendFL & 23 & -56.74 & 4649 & 2.63 & -0.11 & -0.01 & 0.34 & 1.12 & 0.22 & 0.80 & 0.20 \\ \hline
\end{tabular}
\end{table*}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
