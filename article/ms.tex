...
One  mechanism for [Mg/Fe] depletion is the introduction of $\alpha$-poor and Fe-rich material released by Type Ia supernovae \citep{tsujimoto2012first} which locally pollutes the normal [Mg/Fe] ratios that arise from Type II supernovae. However, the two populations in NGC 2419 are indistinguishable in their [Fe/H] abundance \citep{cohenkirby2012}. Furthermore, Type Ia supernova enrichment cannot account for the enhanced K abundance observed in NGC 2419. In fact it is hard to make K in sufficient quantities anywhere without invoking unrealistic temperature conditions or increasing reaction rates above those measured by several orders of magnitude \citep{ventura2012,iliadis2016}. Another mechanism for reducing [Mg/Fe] is through the Mg--Al nucleosynthetic chain in high-temperature hydrogen burning. However, no correlation between Mg and Al is observed in NGC 2419 \citep{cohenkirby2012,mucciarelli2012}. Recent work by \cite{ritter2017} on K production in O-C shell mergers in very low-metallicity stars shows promise as an alternative source of K but this work not sufficiently quantitative yet. 
...
From a sample of 454,180 giant stars in \lamost, we identify 112 candidate stars that are significantly enhanced in K and depleted in Mg. Stars with this chemical pattern have been observed in globular clusters NGC 2419 and NGC 2808; this work represents the first observations of field stars with this peculiar abundance signature. Our candidates are not restricted to a particular phase of stellar evolution, and their metallicity distribution is reflective of the parent \lamost\ sample.
